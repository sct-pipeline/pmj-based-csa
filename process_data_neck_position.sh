...
python $PATH_SCRIPT/get_distance_pmj_disc.py -centerline ${file_t2_seg}_centerline_extrapolated.csv -disclabel ${file_t2_seg}_labeled_discs.nii.gz -o ${PATH_RESULTS}/disc_pmj_distance.csv -spinalroots ${file_nerve}
